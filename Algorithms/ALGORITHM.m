...
% The default output function of ALGORITHM
    ...
    %clc; fprintf('%s on %d-objective %d-variable %s (%d / %d), %.2fs passed...\n',class(Algorithm),Problem.M,Problem.D,class(Problem),Problem.FE, Problem.maxFE,Algorithm.metric.runtime);
    %fprintf('%s on %d-objective %d-variable %s (%d / %d), %.2fs passed...\n',class(Algorithm),Problem.M,Problem.D,class(Problem),Problem.FE, Problem.maxFE,Algorithm.metric.runtime);
    fprintf('%s: %d-objs %d vars %s (%d / %d), %.2fs passed -> ',class(Algorithm),Problem.M,Problem.D,class(Problem),Problem.FE, Problem.maxFE,Algorithm.metric.runtime);
    if Problem.FE >= Problem.maxFE
        ...
        elseif Algorithm.save > 0
            ...
            file   = fullfile(folder,sprintf('%s_%s_%d_',class(Algorithm),class(Problem)));
            runNo  = 1;
