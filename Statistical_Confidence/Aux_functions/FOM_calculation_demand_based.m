function [RC,SC,UC,EC,TTS, Ill,B,P]=FOM_calculation_demand_based(B_T,b_slots, P_T, Ill, B, P,c_scenario,n_users, beams, theta, colours, frame, frame_dur, TTL, freq)
RC=0;
SC=0;
UC=0;
EC=0;
...
%                     % Extra_losses.Ag; Extra_losses.Ac; Extra_losses.Ar; Extra_losses.As; Extra_losses.At;
        ...
        %             end
                    ...
                    B(c_scenario(idx_max2min(beam_idx)).users(u_idx).id,t)=10^(BW_rx/10);
