function x=DB_Mutation_Instants(t_mutation_array, x, B_T,b_slots, P_T, UpC, c_scenario,n_users,number_cells, beams, theta, colours, frame, frame_dur, TTL, freq)
...
for t=1:frame %1frame=10 subframe by 10subframe (beamswithching is performed each frame, for 10 slots constant illumination constant)
    ...
    if any(t==t_mutation_array) % DECISSION TO BE TAKEN BY DB
